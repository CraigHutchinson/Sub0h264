...
**Optimisation:**
- Roadmap: [docs/optimization/esp32p4_hierarchical_plan.md](docs/optimization/esp32p4_hierarchical_plan.md)
- Execution plan with KPI gates: [docs/optimization/execution_plan.md](docs/optimization/execution_plan.md)
- 19 per-opportunity briefs: [docs/optimization/opportunities/](docs/optimization/opportunities/)
- Top-impact items (L3.1 reference prefetch, L2.1 diagonal MC 2-pass,
  L4.5 getSample elimination) together target +7 fps on Ball.
- History + delta + trend in `docs/run_all_report.md` (regenerated by
