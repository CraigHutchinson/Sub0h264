// CABAC context initialization (m, n) parameters.
// Extracted from libavc gau1_ih264_cabac_ctxt_init_table.
// preCtxState = Clip3(1, 126, ((m * SliceQPY) >> 4) + n)
// init_idc 0-2: cabac_init_idc for P/B slices; init_idc 3: I-slice
inline constexpr int8_t cCabacInitMN[4][460][2] = {
    // init_idc 0
    {
        ...
        {   0,  58}, {  -3,  70}, {  -6,  79}, {  -8,  85}, {   0,   1}, { -13, 106}, { -16, 106}, { -10,  87},
    ...
    // init_idc 1
    {
        ...
        {  39, -18}, {  32, -12}, { 102, -94}, {   0,   1}, {  56, -15}, {  33,  -4}, {  29,  10}, {  37,  -5},
        {  51, -29}, {  39,  -9}, {  52, -34}, {  69, -58}, {  67, -63}, {  44,  -5}, {  32,   7}, {  55, -29},
        {  32,   1}, {   0,   1}, {  27,  36}, {  33, -25}, {  34, -30}, {  36, -28}, {  38, -28}, {  38, -27},
        ...
        {  -1,  61}, {  -5,  73}, {  -1,  70}, {  -4,  78}, {   0,   1}, { -21, 126}, { -23, 124}, { -20, 110},
    ...
    // init_idc 2
    {
        ...
        { -10,  76}, { -13,  86}, {  -9,  83}, { -10,  87}, {   0,   1}, { -22, 127}, { -25, 127}, { -25, 120},
    ...
    // init_idc 3
    {
        ...
        { -10,  79}, { -12,  86}, { -13,  90}, { -14,  97}, {   0,   1}, {  -6,  93}, {  -6,  84}, {  -8,  79},
