...
inline constexpr uint8_t cCoeffTokenCode[3][4][16] = {
    {
...
inline constexpr uint8_t cCoeffTokenSize[3][4][16] = {
    {
...
/// Chroma DC coeff_token code values: [trailingOnes][totalCoeff-start]
/// For nC == -1 (chroma DC 2x2 block, max 4 coefficients)
inline constexpr uint8_t cCoeffTokenCodeChroma[4][4] = {
    { 7,  4,  3,  2, },
    { 1,  6,  3,  3, },
    { 0,  1,  2,  2, },
    { 0,  0,  5,  0, },
...
/// Chroma DC coeff_token code sizes: [trailingOnes][totalCoeff-start]
inline constexpr uint8_t cCoeffTokenSizeChroma[4][4] = {
    { 6,  6,  6,  6, },
    { 1,  6,  7,  8, },
    { 0,  3,  7,  8, },
    { 0,  0,  6,  7, },
